...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BusComponent = /** @class */ (function () {
                function BusComponent(activatedRoute, rutasService, busService, dialog, paradasService) {
                    var _this = this;
                ...
                BusComponent.prototype.obtenerParadasdeRuta = function () {
                ...
                BusComponent.prototype.setActivoDirections = function () {
                    this.activoDirections = !this.activoDirections;
                };
                BusComponent.prototype.setActivoParadas = function () {
                        ...
                        if (navigator.geolocation) {
                            this.id = navigator.geolocation.watchPosition(function (datos) {
                                ...
                                if (_this.busAsociadoConductor.latitud !== datos.coords.latitude || _this.busAsociadoConductor.longitud !== datos.coords.longitude
                                    ...
                                    _this.busAsociadoConductor.sentido = datos.coords.heading;
                                    _this.GPSdesactivado = false;
                                    _this.actualizarPosicionEnBaseDeDatos();
                                }
                            }, function () { console.log('No esta activado el gps'); M.toast({ html: 'No esta activado el gps' }); _this.GPSdesactivado = true; });
                        }
                        else {
                            this.reiniciarPosicion();
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditBusesComponent = /** @class */ (function () {
                ...
                EditBusesComponent.prototype.addRuta2 = function (ruta) {
                    var _this = this;
                    if (ruta._id) {
                        this.rutaService.putRuta(ruta)
                            .subscribe(function (res) {
                            _this.actualizarRutaEnBuses(ruta);
                ...
                EditBusesComponent.prototype.asignarOrigenDestinoRuta = function (form) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapaComponent = /** @class */ (function () {
                ...
                MapaComponent.prototype.getDirection = function (direccion) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ParadasComponent = /** @class */ (function () {
                ...
                ParadasComponent.prototype.resetForm = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchComponent = /** @class */ (function () {
                ...
                SearchComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.activatedRoute.params.subscribe(function (params) {
                        _this.rutasSearch = _this.rutasServices.buscarRutas(params.termino); // buscar por nombre bus
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.errorEmail = function () {
            ...
            var RegisterComponent = /** @class */ (function () {
                ...
                RegisterComponent.prototype.onRegister = function (form) {
                    ...
                    if (form.valid) {
                        ...
                        }, function (error) { console.log(error, 'error U.u'); });
                    }
                    else {
                        console.log('No valido');
                    }
                };
                RegisterComponent.prototype.usuarioAgg = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Bus = /** @class */ (function () {
                ...
                function Bus(_id, placa, tipoBus, ConductorAsociado, RutaAsociada, longitud, latitud, sentido) {
                    ...
                    if (ConductorAsociado === void 0) { ConductorAsociado = new _user__WEBPACK_IMPORTED_MODULE_2__["UserI"](); }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Ruta = /** @class */ (function () {
                // tslint:disable-next-line:variable-name
                function Ruta(_id, nombre, descripcion, imagenBus, Fecha, imagenTipoBus, NumBusesAsociados, origen, destino) {
                    if (_id === void 0) { _id = ''; }
                    if (nombre === void 0) { nombre = ''; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.login = function (user) {
                    ...
                    }, function (error) { console.log(error, 'Email o Contrasena incorrecta'); }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ParadasService = /** @class */ (function () {
                ...
                ParadasService.prototype.getParadas2 = function () {
                    this.getParadas();
                    return this.paradas;
                };
                ...
                ParadasService.prototype.getParadaByRuta = function (nombreRuta) {
                    var array = [];
                    for (var _i = 0, _a = this.paradas; _i < _a.length; _i++) {
                        var parada = _a[_i];
                        for (var _b = 0, _c = parada.rutasAsociadas; _b < _c.length; _b++) {
                            var nombreParada = _c[_b];
